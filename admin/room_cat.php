			...
			<div class="main-page">
				<div class="four-grids">
					<div class="col-md-3 four-grid">
						...
						<form action="../actions/insert_room.php" method="POST">
                        <label> Enter The type of room</label>
                    <input type="text" class="control" placeholder="Enter room type..." name="room_type" required><br><br>
					...
					<table class="table table-hover">
						...
						<?php
						 ...
						 ?>
							...
							<tbody>
									<tr>
									<input type="hidden" value="<?php echo $cat["cat_id"] ?>" id="info">
							<td ><?php echo $cat["cat_id"] ?></td>
                            <td ><?php echo $cat["cat_name"] ?></td>
							
							
							<form action="update_cat.php" method="GET"> 
								<input type="hidden" value="<?php echo $cat['cat_id'] ?>" name="up_id">
                            <td><button type="submit" class="label label-success"  name ="update_btn" style="width: 100px; height: 40px;">Update</button></td>
							</form>
                                
							<td><button class="label label-danger" onclick ="delDoc(<?php echo $cat['cat_id'] ?>)" style="width: 100px; height: 40px;">Delete</button></td>
...
// 
				$.ajax({
					type: "POST",
					url:"../actions/delete_cat.php",
					data: dataString,
					cache:false,
					success:function(info){
                  alert(info);
                  window.location="../admin/room_cart.php"
